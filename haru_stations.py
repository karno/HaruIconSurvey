...
special_name_stations = {
    ...
    "LTCCN": [ "環鉄新長府", "かんてつしんちょうふ" ],
    "MMHHH": [ "役場前(東梅田)", "やくばまえ（ひがしうめだ）" ],
    "RTTSB": [ "新線筑波", "しんせんつくば" ],
    "RJEEE": [ "EFB城", "えたーなるふぉーすぶりざーどじょう" ],
    "RSEEE": [ "EFB城", "えたーなるふぉーすぶりざーどじょう" ],
    "SCEEE": [ "EFB城", "えたーなるふぉーすぶりざーどじょう" ],
    "SCHHH": [ "新役場", "しんやくば" ],
    "SNHHH": [ "新役場", "しんやくば" ],
    "ZIHHH": [ "旧 役場前", "きゅうやくばまえ" ],
    # 飛行場系
    "ATTTT": [ "津ヘリポート", "つへりぽーと" ],
    "ASSHI": [ "しきみ島空港", "しきみじまくうこう" ],
    "AOOMR": [ "大室飛行場", "おおむろひこうじょう" ],
    # 船系
    "B2SH3": [ "ship3 #2", "しっぷ３　＃２" ],
    "B3SH3": [ "ship3 #3", "しっぷ３　＃３" ],
}