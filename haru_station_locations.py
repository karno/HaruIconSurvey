...
station_locations = {
    ...
    "HH": {
        ...
        "KAE": (-279, 73, -1537, "楓"),
        "AOH": (268, 73, -1559, 0, 0, "青木ヶ原"),  # <夜間通過> 565 blocks
        "SKV": (574, 73, -1536, "鮭の子村"),  # 323 blocks
        "SKP": (574, 73, -1278, "鮭の子港"),  # 258 blocks
    },
    # harutrak I
    "HI": {
        # 駅共有/片側乗入(逆側ポイント分岐): HCTI(TT方面)
        "TSI": (206, 69, -142, "津入口"),
        "KAN": (1125, 69, 97, "北香住"),  # 1154 blocks
    },
    # harutrak 空港連絡線
    "HZ": {
        # 片側乗入: HC(JT方面)
    ...
    "RJ": {
        ...
        "KEI": (-141, 44, 225, "刑務所東"),  # 192 blocks
    ...
    "ET": {
        ...
        "TSY": (-562, 72, 416, "月屋根沢"),  # 241 blocks
    ...
    "EX": {
        # 駅共有/相互直通: RNHH
        "HHH": (-277, 59, 346, "役場前"),
        "TSY": (-562, 72, 416, "月屋根沢"),  # 361 blocks
    ...
    "EK": {
        ...
        "EEE": (-829, 49, -24, "EFB城前"),  # 253 blocks
        "YOZ": (-944, 49, -6, "夜築町"),  # 131 blocks
    },
    # はる急行鉄道 参宮線
    "ES": {
        # 駅共有/相互直通: EKTY
    ...
    "MM": {
        ...
        "JJJ": (-76, 72, 85, "城南"),
        "HHH": (-258, 67, 295, "役場前(東梅田)"),  # NK-HH: 230, JJ->HH: 388
    ...
    # はる近郊鉄道 内環線
    "NI": {
        "JIR": (-328, 74, 720, "辞林"),  # 169 blocks (from NINR)
        ...
        "NNO": (-258, 74, 83, "中野"),  # 157 blocks
        "NNC": (-223, 54, 90, "地下鉄中野"),  # 58 blocks
        "KEI": (-162, 66, 222, "刑務所東"),  # 189 blocks
        "SHK": (-173, 72, 308, "湘南海岸"),  # 91 blocks
        "FUO": (-175, 72, 355, "藤が丘東"),  # 48 blocks
        "SHJ": (-173, 47, 411, "しきみ城"),  # 56 blocks
        "MIN": (-175, 53, 449, "北三原"),  # 41 blocks
        "MIH": (-184, 52, 540, "三原"),  # 96 blocks
        "NMO": (-249, 47, 654, "中森"),  # 151 blocks
    },
    # はる近郊鉄道 空港線
    "NA": {
    ...
    # 東部環状鉄道 東部環状線
    "LT": {
        "HHH": (-269, 59, 346, "役場前"),  # 107 blocks (from LTGZ)
    ...
    "TR": {
        ...
        "TSU": (520, 68, 566, "筑波大学"),  # 86 blocks
        "TSB": (556, 64, 630, "筑波"),  # 90 blocks
        "SAT": (653, 64, 630, "桜土浦"),  # 98 blocks
        "TST": (758, 69, 626, "土浦"),  # 97 blocks
        # TRTU -> [TROA, TRSK]
        ...
        #
        "SHZ": (911, 67, 754, "下北沢"),  # 278 blocks (from TU)
