...
station_locations = {
    ...
    # はる近郊鉄道 内環線
    "NI": {
        "JIR": (-328, 74, 720, "辞林"),  # 169 blocks (from NINMO)
        ...
        "KEE": (-162, 66, 222, "刑務所東"),  # 189 blocks
    ...
    "TR": {
        ...
        "TSU": (758, 69, 626, "土浦"),  # 97 blocks
        # TRTSU -> [TROAR, TRSHZ]
        # TRTSU -> TROARへは継続運転. TRTSU -> TRSHZへは対面乗換
        # TROAR, TRSHZ -> TRTSU 以降は継続運転
