...
lines = {
    ...
    # X: はる急行鉄道 - @karno
    "XT": ( "はる急行鉄道", "月沢本線", "#FF0000" ),
    "XX": ( "はる急行鉄道", "月沢急行線", "#A10000" ),
    "XN": ( "はる急行鉄道", "南海急行線", "#006A3A" ),
    "XH": ( "はる急行鉄道", "北越線", "#008CFF" ),
    "XE": ( "はる急行鉄道", "北越急行線", "#0138CF" ),
    "XS": ( "はる急行鉄道", "参宮線", "#D00074" ),
    "XC": ( "はる急行鉄道", "中部丘陵線", "#D59758" ),
    ...
    # K: はる近郊鉄道 - @hnakai0909
    "KI": ( "はる近郊鉄道", "内環線", "#DBCC75" ),
    "KA": ( "はる近郊鉄道", "空港線", "#DBCC75" ),
    "KS": ( "はる近郊鉄道", "森林都市線", "#6B4794" ),


    # F: こむぎ娘レールウェイ - @flour4445
    "FC": ( "こむぎ娘レールウェイ", "千歳線", "#969182" ),
    "FK": ( "こむぎ娘レールウェイ", "海岸線", "#969182" ),
    "FS": ( "こむぎ娘レールウェイ", "作長線", "#969182" ),
    "FT": ( "こむぎ娘レールウェイ", "東海線", "#969182" ),
    "FO": ( "こむぎ娘レールウェイ", "東西線", "#969182" ),
    ...
    "WN": ( "比那名居電鉄", "南海佐倉線", "#49DC00" ),
    "WM": ( "比那名居電鉄", "三名線", "#D5242A" ),
